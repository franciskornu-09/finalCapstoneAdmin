...
@section('content')
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
           ...
           <div class="col-md-4 col-sm-6 margin-bottom-30">
                <a href="#" class="btn btn btn-secondary btn-lg active" role="button" aria-pressed="true" style="width: 100%"><i class="fa fa-dollar fa-3x" style="margin-top:20px"></i> &nbsp;Transaction Tab</a>   
          </div> 
           <div class="col-md-4 col-sm-6 margin-bottom-30">
